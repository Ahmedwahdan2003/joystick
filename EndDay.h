...
#pragma endregion
	...
	private: System::Void display_total_btn_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ connnString = "Server=AHMED-WAHDAN\\SQLEXPRESS;Database=joystick;Trusted_Connection=True;";
		...
		String^ connnnString = "Server=AHMED-WAHDAN\\SQLEXPRESS;Database=joystick;Trusted_Connection=True;";
